               ...
               <div class="swiper-slide">
                   <div class="overflow-hidden position-relative h-100">
                       ...
                       <div class="slideshow-text container position-absolute start-50 top-50 translate-middle ">
                           <div class="">
                               <h2 class="text-capitalize text-white fw-bold mb-0 animate animate_fade animate_btt animate_delay-4 fs-38 textmb mb-3">
                  ...
                  { ?>
                      <div class="swiper-slide blog-grid__item mb-4 eventblock1">
                        ...
                        <div class="blog-grid__item-detail eventimgdiv2 eventScrolldiv">
                           <div class="">
                              <h2><?=(!empty($e_val['title'])) ? ucfirst($e_val['title']) : ''; ?></h2>
                           </div>
