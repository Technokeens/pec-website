            ...
            <div class="ibox-content">
               <form action="" method="post" class="form-horizontal" name="frm_add_product" id="frm_add_product" enctype="multipart/form-data">
                  <div class="form-group ">
                     ...
                     <div class="col-sm-4">
                        <input type="number" id="position" name="position" min="0" class="position form-control">
                     </div>
                  </div>
                     ...
                     <div class="col-sm-4">
                        <select id="series_id" name="series_id" class="form-control" style="text-transform: capitalize;">
                          ...
                          if(!empty($series))
                          {
                            ...
                            {
                        ?>
                              <option value="<?=$val['ps_id'];?>"><?php echo ucwords($val['title']);?></option>
                        <?php
                            }
                          }
                        ?>
                          ...
                          if(!empty($applications))
                            {
                              ...
                              {
                          ?>
                                <option value="<?=$app_val['t_id'];?>"><?php echo ucwords($app_val['title']);?></option>
                          <?php
                              }
                            }
                          ?>
                  ...
                  <div class="form-group ">
                          ...
                          if(!empty($power_ratings_list))
                            {
                              ...
                              {
                          ?>
                                <option value="<?=$pr_val['pr_id'];?>"><?php echo ucwords($pr_val['power_rating']);?></option>
                          <?php
                              }
                            }
                          ?>
                     ...
                     <div class="col-sm-4">
                        <input type="text" id="tcr_ppm_c" name="tcr_ppm_c" class="position form-control">
                     </div>
                  ...
                  <div class="form-group ">
                     ...
                     <div class="col-sm-4">
                        <input type="text" id="min_resistance" name="min_resistance" class="form-control">
                     </div>

                     <label class="col-sm-2 control-label">Max Resistance Value <br>(Ohms)</label>
                     <div class="col-sm-4">
                        <input type="text" id="max_resistance" name="max_resistance" class="form-control">
                     </div>
                  </div>
                  <div class="hr-line-dashed" ></div>
                  <div class="form-group ">
                     ...
                     <div class="col-sm-4">
                        <input type="text" id="termination_type" name="termination_type" class="form-control">
                     </div>

                     <label class="col-sm-2 control-label">Resistor Tolerance</label>
                     <div class="col-sm-4">
                        <input type="text" id="resistor_tolerance" name="resistor_tolerance" class="form-control">
                     </div>
                  </div>
                  <div class="hr-line-dashed" ></div>
                  <div class="form-group ">
                     ...
                     <div class="col-sm-4">
                        <input type="number" id="dimension_width" name="dimension_width" step="any" min="0" class="form-control">
                     </div>

                     <label class="col-sm-2 control-label">Dimensions Body Length - Height</label>
                     <div class="col-sm-4">
                        <input type="number" id="dimension_height" name="dimension_height" step="any" min="0" class="form-control">
                     </div>
                  </div>
                  ...
                  <div class="form-group ">
                     ...
                     <div class="col-sm-10">
                        <input type="text" id="cross_reference" name="cross_reference" class="position form-control" data-role="tagsinput"><br>
                  ...
                  <div class="form-group ">
                     ...
                     <div class="col-sm-4">
                         <input type="text" id="meta_title" name="meta_title" class="meta_title form-control">
                     </div>
                  </div>
                  <div class="form-group ">
                     <label class="col-sm-2 control-label">Meta Keyword</label>
                     <div class="col-sm-10">
                        <input type="text" id="meta_keyword" name="meta_keyword" class="meta_keyword form-control">
                        <br>
                        <span style="color: green;">For keyword separation use comma (,) </span>
                     </div>
                  </div>
                  <div class="form-group ">
                     ...
                     <div class="col-sm-10">
                        <textarea rows="4" cols="50" id="meta_description" name="meta_description" class="form-control"></textarea>
                     </div>
                  </div>
                          ...
                          if(!empty($series))
                            {
                              ...
                              {
                          ?>
                                <option value="<?=$series_val['ps_id'];?>"><?php echo ucwords($series_val['title']);?></option>
                          <?php
                              }
                            }
                          ?>
