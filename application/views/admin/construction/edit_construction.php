...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">
            <strong>Edit Construction</strong>
         </li>
      </ol>
   </div>
   <div class="col-lg-2">
      ...
      <div class="col-lg-12">
         <div class="ibox float-e-margins">
            <div class="ibox-content">
               <form action="" method="post" class="form-horizontal" name="frm_add_construction" id="frm_add_construction" enctype="multipart/form-data">
                  
                  <div class="form-group ">
                     <label class="col-sm-2 control-label">Construction Title</label>
                     <div class="col-sm-10">
                        <input type="text" id="construction_title" name="construction_title" class="form-control" value="<?php echo $detail['construction_title'];?>">
                     </div>
                  </div>
                  ...
                  <div class="form-group ">
                     ...
                     <div class="col-sm-10">
                        <textarea rows="4" cols="50" id="construction_description" name="construction_description" class="form-control"><?php echo $detail['construction_description'];?></textarea>
                  ...
                  <div class="form-group">
                     <div class="col-sm-4 col-sm-offset-2">
                        <button type="submit" class="btn btn-w-m btn-primary" id="btn_edit_construction" name="btn_edit_construction" value="submit"><i class="icon-ok"></i> Save</button>
...
<script type="text/javascript">
  ...
  {
    $("#frm_add_construction").on('submit',function()
    {     
