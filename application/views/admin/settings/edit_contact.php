edit_contact<style type="text/css">
                  ...
                  <div class="ibox-content">
                     <form action="" method="post" class="form-horizontal" name="frm_contact" id="frm_contact" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-4">
                              <input type="text" id="address_title" name="address_title" class="form-control" value="<?=$contacts['address_title'];?>">
                           </div>

                           <label class="col-sm-2 control-label">Company Name</label>
                           <div class="col-sm-4">
                              <input type="text" id="company_name" name="company_name" class="form-control" value="<?=$contacts['company_name'];?>">
                           </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Person Name</label>
                           <div class="col-sm-4">
                              <input type="text" id="person_name" name="person_name" class="form-control" value="<?=$contacts['person_name'];?>">
                           </div>

                            <label class="col-sm-2 control-label">Email</label>
                           <div class="col-sm-4">
                              <input type="text" id="emailid" name="email" class="form-control" value="<?=$contacts['email'];?>">
                           </div>
                        </div>     
                        <div class="form-group">
