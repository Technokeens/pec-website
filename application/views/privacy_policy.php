...
<main class="mbtopmain">
    ...
    <section class="container mbbottom mb-5">
      ...
      <p class="mb-2">
        ...
        <ul>
          <li>With Service Providers: We may share your information with third-party service providers to perform tasks on our behalf and to assist us in providing our services.</li>
          <li>For Business Transfers: If we are involved in a merger, acquisition, or asset sale, your information may be transferred as part of that transaction.
        With Your Consent: We may disclose your personal information for any other purpose with your consent.</li>
        <li>For Legal Requirements: We may disclose your information when required by law or to respond to valid requests by public authorities.</li>
        </ul>
      </p>
      <h6 class="mb-3">Security of Your Information</h6>
      <p class="mb-4 pb-3">The security of your personal information is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your personal information, we cannot guarantee its absolute security.</p>
      <h6 class="mb-3">Your Data Protection Rights</h6>
      <p class="mb-2">Depending on your location, you may have the following rights regarding your personal data:
