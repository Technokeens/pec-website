...
$upload_dir = array(
 ...
 'img'=> 'ayurveda_live/assets/ckeditor2/images/',

 'audio'=> 'ayurveda_live/assets/ckeditor2/images/'
...
$imgset = array(
 ...
 'maxwidth' => 10000,     // maximum allowed width, in pixels

 'maxheight' => 10000,    // maximum allowed height, in pixels

 'minwidth' => 50,      // minimum allowed width, in pixels

 'minheight' => 50,     // minimum allowed height, in pixels
...
$audioset = array(
 ...
 'maxsize' => 30000,     // maximum file size, in KiloBytes (20 MB)
...
if(isset($_FILES['upload']) && strlen($_FILES['upload']['name']) >1) {
  ...
  if(in_array($type, $imgset['type'])){
    ...
    if(isset($width) && isset($height)) {
      ...
      if($_FILES['upload']['size'] > $imgset['maxsize']*2000) $re .= '\\n Maximum file size must be: '. $imgset['maxsize']. ' KB.';
    ...
    if($_FILES['upload']['size'] > $audioset['maxsize']*2000) $re .= '\\n Maximum file size must be: '. $audioset['maxsize']. ' KB.';
  ...
  if($re == '') {
    ...
    if(move_uploaded_file($_FILES['upload']['tmp_name'], $uploadpath)) {
      ...
      $msg = F_NAME .'.'. $type .' successfully uploaded: \\n- Size: '. number_format($_FILES['upload']['size']/3500, 2, '.', '') .' KB';
